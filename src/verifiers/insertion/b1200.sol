...
contract Verifier {
    ...
    uint256 constant DELTA_NEG_X_0 =
        15874817780684673955351189313926656498967134008679435835646246038655196613190;
    uint256 constant DELTA_NEG_X_1 =
        5806838965219297294734248079255631864517207036205036938477494561514197536472;
    uint256 constant DELTA_NEG_Y_0 =
        3706799635757198098607068907191722427136425626923032908218996145491495915667;
    uint256 constant DELTA_NEG_Y_1 =
        11168883935192265317529997104415097474587873139452458989637634040464956752062;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        8965172169124420801633888426938584094147179610572163355420013473775171347727;
    uint256 constant CONSTANT_Y =
        14248618662964254704125389251071622163627393379261465267585317988365613849050;
    uint256 constant PUB_0_X =
        16513236097808208274636834936190587838609048056986316367998699417646079295054;
    uint256 constant PUB_0_Y =
        12755327544689601979672034529847979715958357295028094767185216559001293611465;
