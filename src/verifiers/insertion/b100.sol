...
contract Verifier {
    ...
    uint256 constant DELTA_NEG_X_0 =
        16041316505337973720467154148943349865897625363579736390485083860626495498453;
    uint256 constant DELTA_NEG_X_1 =
        10522723813351528934879639856781720834129441345604026700179779862101055282930;
    uint256 constant DELTA_NEG_Y_0 =
        2903378531647801286638503022165300054911108965086504997601488524438106939226;
    uint256 constant DELTA_NEG_Y_1 =
        41286715756040242870074710130575255080507681563570354343900340187283074023;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        21218919093375691446909846506142737136095584477730465371304041975958407877680;
    uint256 constant CONSTANT_Y =
        6016048480083357554053669007605630654637703437721929578037084015188199409726;
    uint256 constant PUB_0_X =
        17555030560675274092735615200345151998983059969648581663381694610054963261777;
    uint256 constant PUB_0_Y =
        3144232321165723268137031961810978634065537316675532722223480646093206168642;
