...
contract Verifier is ITreeVerifier4844 {
    ...
    uint256 constant ALPHA_X =
        2708969884581619714583557951222918593768772820936646583136789853819173846869;
    uint256 constant ALPHA_Y =
        8043584586634431593445517970972074344995663485134139288455040086659571635007;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        2959634726718323159960582986494250462813569884099052977631775603535594317697;
    uint256 constant BETA_NEG_X_1 =
        2567045386415897874314697628037970624972832810910119870003888717933699604901;
    uint256 constant BETA_NEG_Y_0 =
        16901523272247727115591169122896696499546950846485806085170956609925505472585;
    uint256 constant BETA_NEG_Y_1 =
        9215676527870136774869096108544312861626222401455601740260979586958004850529;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        8904268816337492794416634636731345512132126205040334900538636341318421538665;
    uint256 constant GAMMA_NEG_X_1 =
        19004930723547195287383134699314663710813331368262617951429852355608517342331;
    uint256 constant GAMMA_NEG_Y_0 =
        7842710818119939895862574378653362734227090432895633776678943219170947197152;
    uint256 constant GAMMA_NEG_Y_1 =
        2119828549076590392190534591515249836229477358991111181013402454206155157118;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        16751268373860897104759671698719630006610347517780893954841247694987729581925;
    uint256 constant DELTA_NEG_X_1 =
        17074355565731257728214063587600772000822732044793320082675686505906845346452;
    uint256 constant DELTA_NEG_Y_0 =
        19276066093240754710159494686794885924197536752080653828868593863903058741434;
    uint256 constant DELTA_NEG_Y_1 =
        10391802489342383226451710090356140861208165419529434978751035344608888508609;
    // Pedersen G point in G2 in powers of i
    uint256 constant PEDERSEN_G_X_0 =
        191329193964481065495212234619899074886870006108961472779204277869671687115;
    uint256 constant PEDERSEN_G_X_1 =
        18448119812880134607636953435856909803133499313412999813309765036275639759714;
    uint256 constant PEDERSEN_G_Y_0 =
        7320805055268657491420712525633197949310593554647878873210287658169673900549;
    uint256 constant PEDERSEN_G_Y_1 =
        3560501050363463728186450810474818536571923785681141032866912257045688789262;
    ...
    uint256 constant PEDERSEN_GROOTSIGMANEG_X_1 =
        11880079357380769452360200537618953332011342321508956754029570189743729673109;
    uint256 constant PEDERSEN_GROOTSIGMANEG_Y_0 =
        20343036341560553279453586916303753798495271995175822900148534636526224647164;
    uint256 constant PEDERSEN_GROOTSIGMANEG_Y_1 =
        18398984926832230363518321101521122731640509584485783610091427005978221352504;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        19358550662348637607112384570170513296928047638941946872811625925166768621689;
    uint256 constant CONSTANT_Y =
        6626464468086658346890654816494620493177727644183109536624044536458730824315;
    uint256 constant PUB_0_X =
        21039846169407040170900369597064405833466068013105470546221436302050929487572;
    uint256 constant PUB_0_Y =
        2611968432498880732075319619253202283148240652063087246949510105674797190280;
    uint256 constant PUB_1_X =
        17167433712229735771674828746728526346122363071518232159739058701502221378434;
    uint256 constant PUB_1_Y =
        1739891145391694203708089066027069569757327500962996441495332028277069755267;
    uint256 constant PUB_2_X =
        17798576048770024481159849810854079136640512359488534233899537955087709779447;
    uint256 constant PUB_2_Y =
        3109649566724390234731095093811315543854286970944206387661935696332701907948;
    uint256 constant PUB_3_X =
        7890320639901919646211933804150885252994659227692929006872667869290059075281;
    uint256 constant PUB_3_Y =
        11396290418620464030035551260992220541169365820463159918373688231853778829859;
    uint256 constant PUB_4_X =
        16030714242136825467561218858637637879071023746882506204693189470117499845846;
    uint256 constant PUB_4_Y =
        14919105472258793272718206026880812470549694675722205962400380939241926000512;
    uint256 constant PUB_5_X =
        15864446105389560446153403630146334838539883248526951175596504258425435272439;
    uint256 constant PUB_5_Y =
        3764670878071624467628034771504294179451467482124027272932022992371176433497;
    uint256 constant PUB_6_X =
        13240007634426972631439790531670899863212947213748180981433638304827247605238;
    uint256 constant PUB_6_Y =
        9107574043090153668746153226362613394226970755908178311480271382776655025033;
