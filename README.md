...
> ID, check out the [integration docs](https://docs.world.org/world-id).

This repository contains the underlying contracts that make World ID 3.0 work, powered by the
